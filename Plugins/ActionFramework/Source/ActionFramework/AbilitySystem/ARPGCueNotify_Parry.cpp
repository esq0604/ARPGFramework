...
bool UARPGCueNotify_Parry::OnExecute_Implementation(AActor* MyTarget, const FGameplayCueParameters& Parameters) const
{
	...
	//const FHitReactionInfo* HitReactInfo = Ability->GetCurrentHitReactionInfo();
	...
	////HitReactComp->PlayParryMontage();

	//ACharacter* Character = Cast<ACharacter>(Parameters.EffectCauser);
	//if (Character && ComboData->DeflectedMontage)
	//{
	//	Character->PlayAnimMontage(ComboData->DeflectedMontage);
	//}
